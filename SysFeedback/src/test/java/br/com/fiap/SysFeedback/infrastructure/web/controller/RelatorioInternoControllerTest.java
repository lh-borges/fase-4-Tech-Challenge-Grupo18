...
class RelatorioInternoControllerTest {
    ...
    @Test
    void comApiKeyValidaEPeriodoInformadoRetornaRelatorioDoPeriodo() throws Exception {
        mockMvc.perform(post("/internal/relatorio/semanal")
                        .header("X-Internal-Api-Key", "chave-de-teste")
                        .param("inicio", "2026-07-01T00:00:00")
                        .param("fim", "2026-07-31T23:59:00"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.periodoInicio").value("2026-07-01T00:00:00"))
                .andExpect(jsonPath("$.periodoFim").value("2026-07-31T23:59:00"))
